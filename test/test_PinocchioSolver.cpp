...
// Helper function to generate a default PinocchioSolverConfig.
PinocchioSolverConfig get_default_test_config() {
    PinocchioSolverConfig config;
...
TEST(KinematicsTest, ForwardKinematicsZeroAngles) {
    ...
    PinocchioSolverConfig config = get_default_test_config();
    PinocchioSolver solver(config);
